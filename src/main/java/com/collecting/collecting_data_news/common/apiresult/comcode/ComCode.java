...
public class ComCode {
    ...
    public final static String SAVED_MY_NEWS = "뉴스 사이트가 저장 되었습니다.";
    public final static String ALREADY_SAVED_MY_NEWS = "이미 저장된 뉴스 사이트 입니다.";
    ...
    public final static String ALREADY_DELETE_DATA = "이미 삭제된 데이터 입니다.";
